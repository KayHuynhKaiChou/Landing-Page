...
import design from '../../asserts/image/Design.png'
import programing from '../../asserts/image/Programming.png'
import technology from '../../asserts/image/Technology.png'
            ...
            <div className={style[`cate-item`]}>
                ...
                <div className={style['cate-detail']}>
                  ...
                  <div className={style['content']}>
                    ...
                    design of products and packaging attractive to buyers; defining the terms of sale, 
                    such as price, discounts, warranty, and return policy.
                  </div>
                </div>
            </div>
          ))}
